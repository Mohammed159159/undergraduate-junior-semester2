...
> - Results of analysis could be used for designing the system: in [[Mechanism Analysis]], for example, finding an unknown length of a link to produce a desired output when given a certain input
> - Types of [[Mechanism Analysis]]
> 	- Positional analysis
> 	- [[Velocity Analysis]]
...
>  
>  - More than one solution could be obtained; reject solutions that do not express your system, assembly of mechanism in case of [[Mechanism Analysis]]
